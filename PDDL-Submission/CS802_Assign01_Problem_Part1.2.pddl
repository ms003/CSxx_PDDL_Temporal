...
(:requirements :strips :typing :equality :numeric-fluents :durative-actions :timed-initial-literals)
    ...
    (:init
       ...
       (= (walk_speed dr2) 0.5)
        ...
        ;;(at 331 (not(available pack1 )))
        ;;(at 10000 (not(available pack2)))
        ;;(at 10000 (not (available pack3)))
        ;;(at 10000 (not (available pack4)))
        ...
        (at 1611(not(available pack1)))
        (at 1430(not(available pack2)))
        (at 1611(not (available pack3)))
        (at 1110(not (available pack4)))
    )
